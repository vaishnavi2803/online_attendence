...
if (isset($_POST['updateBtn'])) {
    ...
    $sql = "UPDATE faculty SET 
        ...
        subject = '$subject',dob = '$dob', doj = '$doj', 
    ...
    if ($result = $mysqli->query($sql)) {
        ...
        if (mysqli_affected_rows($mysqli) > 0) {
            $_SESSION['success-msg'] = "Faculty details has been successfully updated.";
            echo '<script> location.replace("list-faculty.php"); </script>';
        }
    }
...
<div class="edit-user">
    <form action="" method="post">
        ...
        <div class="form-group row align-items-center">
            ...
            <div class="col-sm-10">
                <input type="text" required class="form-control" name="subject" id="subject" placeholder="Enter subject" value="<?php echo $row['subject'] ?>">
            </div>
        </div>
